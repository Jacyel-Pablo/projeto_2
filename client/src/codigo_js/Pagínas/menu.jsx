    ...
    return(
        <div className={style.body_pag} onKeyDown={(e) => enviar(e)} onLoad={lancamento()}>
            ...
            <nav className={style2.menu}>
                <a className={style2.menu_a} name="ShowTime" to="/menu.html">
                ...
                <input className={style2.campo__busca} id="pesquisa" placeholder="Pesquisa" onChange={(e) => setDados_campo(copiar => ({
                    ...copiar,
