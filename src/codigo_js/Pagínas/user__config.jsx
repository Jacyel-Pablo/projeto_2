        ...
        <div className={style.corpo}>
            <section className={style.box1}>
                ...
                <div className={style.nome__config}>
                    ...
                    <input id="input_alterar_nome" onChange={(e) => adicionar_nome_input(e)} value={dados.input_valor} className={style.user__name__input} type="text" style={dados.input_width}/>
