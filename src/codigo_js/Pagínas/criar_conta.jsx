                ...
                <div className={`${style.container_formulario1} border d-flex justify-content-center align-items-center`}>
                    <form className="row w-75">
                        ...
                        <div>
                            ...
                            <input onChange={(e) => {seta_valores(e)}} id="apelido" type="text" className="form-control bg-dark text-white mb-3"/>
                        </div>
                        <div>
                            <label for="inputEmail4" className="form-label">Email:</label>
                            <input onChange={(e) => {seta_valores(e)}} id="email" type="email" className="form-control bg-dark text-white mb-3"/>
                            </div>
                        <div>
                            <label for="inputPassword4" className="form-label">Password:</label>
                            <input onChange={(e) => {seta_valores(e)}} id="senha" type="password" className="form-control bg-dark text-white mb-3"/>
                        </div>
                        <div class="ms-0">
                            <a onClick={() => enviar()} href="/" id="enviar" type="submit" className="btn text-white bg-danger">Criar</a>
                        </div>
                    </form>
                </div>
            </div>
